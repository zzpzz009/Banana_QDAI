...
export const Toolbar: React.FC<ToolbarProps> = ({
    ...
    if (isCropping) {
        return (
            ...
            >
                ...
                >
                    <option value="" className="text-black">{t('toolbar.crop.free')}</option>
                    <option value="1:1" className="text-black">{t('toolbar.crop.ratio_1_1')}</option>
                    <option value="2:3" className="text-black">{t('toolbar.crop.ratio_2_3')}</option>
                    <option value="3:2" className="text-black">{t('toolbar.crop.ratio_3_2')}</option>
                    <option value="3:4" className="text-black">{t('toolbar.crop.ratio_3_4')}</option>
                    <option value="4:3" className="text-black">{t('toolbar.crop.ratio_4_3')}</option>
                    <option value="4:5" className="text-black">{t('toolbar.crop.ratio_4_5')}</option>
                    <option value="5:4" className="text-black">{t('toolbar.crop.ratio_5_4')}</option>
                    <option value="9:16" className="text-black">{t('toolbar.crop.ratio_9_16')}</option>
                    <option value="16:9" className="text-black">{t('toolbar.crop.ratio_16_9')}</option>
    ...
    return (
        ...
        <input type="color" aria-label={t('toolbar.strokeColor')} title={t('toolbar.strokeColor')} value={drawingOptions.strokeColor} onChange={(e) => setDrawingOptions({ ...drawingOptions, strokeColor: e.target.value })} className="w-7 h-7 p-0 border border-[var(--border-color)] pod-rounded-full cursor-pointer bg-transparent pod-color-swatch-circle" />
            ...
            <div className="w-10" style={{ height: '1px', backgroundColor: 'var(--border-color)' }}></div>
            <ToolButton label={t('toolbar.recenter')} onClick={onRecenter} icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"></circle><line x1="12" y1="2" x2="12" y2="6"></line><line x1="12" y1="18" x2="12" y2="22"></line><line x1="2" y1="12" x2="6" y2="12"></line><line x1="18" y1="12" x2="22" y2="12"></line></svg>} />
