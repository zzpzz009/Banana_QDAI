...
> 当前代码对应 Git 标签：`qd1.1.5`（分支：`rollback-qd0.1.0`）

---

## 版本亮点（qd1.1.5）

- 画布触摸交互升级：单指拖动即可平移画布，配合现有缩放操作，更适配 iPad 与触控板场景。
- 框选方式优化：支持单指长按后拖动框选，一次选择多张图片或元素，便于批量移动与调整。
